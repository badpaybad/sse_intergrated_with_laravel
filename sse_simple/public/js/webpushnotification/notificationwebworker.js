self.importScripts('/js/webpushnotification/EventSourceClient.js');
...
if (isMobile() || !typeOfWorker || typeOfWorker == 'undefined') {
  typeOfWorker = "Worker";
}
...
var sseClient = new EventSourceClient(token);
...
sseClient.addHandler(function (msg) {
  try {
    msg = JSON.parse(msg);
